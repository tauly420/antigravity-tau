...
const EXAMPLE_DATA = {
    ...
    rows: [
        { 'Extension (m)': 0.01, 'Force (N)': 0.51, 'Force Error (N)': 0.25, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.02, 'Force (N)': 0.98, 'Force Error (N)': 0.25, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.03, 'Force (N)': 1.52, 'Force Error (N)': 0.30, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.04, 'Force (N)': 2.05, 'Force Error (N)': 0.30, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.05, 'Force (N)': 2.48, 'Force Error (N)': 0.35, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.06, 'Force (N)': 3.02, 'Force Error (N)': 0.35, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.07, 'Force (N)': 3.55, 'Force Error (N)': 0.40, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.08, 'Force (N)': 4.01, 'Force Error (N)': 0.40, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.09, 'Force (N)': 4.53, 'Force Error (N)': 0.45, 'Extension Error (m)': 0.005 },
        { 'Extension (m)': 0.10, 'Force (N)': 5.05, 'Force Error (N)': 0.50, 'Extension Error (m)': 0.005 },
    ],
};
